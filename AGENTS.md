...
Applies to all repositories in the Yakoon organization. Repository
specifics (e.g. the Executor ABI in `runtime`) are documented in the
repository's own `AGENTS.md` and take precedence locally.
